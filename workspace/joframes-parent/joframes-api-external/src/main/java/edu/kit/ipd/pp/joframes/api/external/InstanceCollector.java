 ...
 */
public final class InstanceCollector {
	/**
	 ...
	 */
	public static void addClass(final Class<?> addedClass) {
	 ...
	 */
	public static void addInstance(final Object o) {
	 ...
	 */
	public static List<Object> getInstances(final Class<?> forClass) {
