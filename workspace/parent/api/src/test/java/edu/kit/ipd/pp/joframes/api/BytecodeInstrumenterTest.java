...
//			assertEquals(15, offInstr.getNumInputClasses());
	 ...
	 */
	private void instrumentBytecode(String frameworkSpecification, String[] frameworkJars, String[] applicationJars,
			String[] applicationJarsForInstrumentation, String output) throws ParseException,
			ClassHierarchyCreationException, InstrumenterException {
